...
function getMockOrders(): Order[] {
  ...
  try {
    ...
    let parsed: any[] = raw ? JSON.parse(raw) : [...INITIAL_MOCK_ORDERS]
    if (parsed.some((o: any) => (o.quoted_value && o.quoted_value > 3000000) || o.sales_rep_id === 'demo-sales-3')) {
      parsed = [...INITIAL_MOCK_ORDERS]
