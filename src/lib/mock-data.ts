...
export const DEMO_USERS: Record<string, User> = {
  ...
  sales_3: {
    id: 'demo-sales-3',
    email: 'rohan.verma@pricedesk.in',
...
export const MOCK_DEALS: Deal[] = [
  {
    ...
    overheads: [
      { id: 'ovh-1', name: 'Freight & Express Transit', amount: 50000 },
      { id: 'ovh-2', name: 'On-site Technical Commissioning', amount: 100000 },
    ],
  ...
  },
  {
    ...
    overheads: [
      { id: 'ovh-3', name: 'Implementation & Configuration', amount: 80000 },
    ],
    requires_technical: true,
    technical_approved_by: 'demo-technical',
  ...
  },
  {
    ...
    overheads: [
      { id: 'ovh-4', name: 'Staging & Custom Image Flashing', amount: 90000 },
    ],
    requires_technical: true,
    technical_approved_by: 'demo-technical',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        transfer_price: 1040000,
        oem: 'VMware',
      },
    ],
    overheads: [
      { id: 'ovh-5', name: 'Rack Installation & SAN Migration', amount: 150000 },
    ],
    requires_technical: true,
  },
  {
    ...
    items: [
      {
        ...
        quantity: 6,
        quoted_price: 620000,
        transfer_price: 490000,
        oem: 'Cisco Systems',
      },
    ],
    overheads: [
      { id: 'ovh-6', name: 'Clinical Integration & Training', amount: 80000 },
    ],
    requires_technical: true,
    technical_approved_by: 'demo-technical',
  ...
  },
  {
    ...
    overheads: [
      { id: 'ovh-7', name: 'On-site Telecom Deployment', amount: 200000 },
    ],
    requires_technical: true,
    technical_approved_by: 'demo-technical',
  ...
  },
  {
    ...
    overheads: [
      { id: 'ovh-8', name: 'SOC Deployment Support', amount: 100000 },
    ],
    requires_technical: true,
    technical_approved_by: 'demo-technical',
    technical_approved_at: new Date(now - 86400000 * 14).toISOString(),
    finance_approved_by: 'demo-finance',
    finance_approved_at: new Date(now - 86400000 * 10).toISOString(),
    sales_head_approved_by: 'demo-head',
...
export const MOCK_AUDIT_LOG: DealAudit[] = [
  ...
  auditEntry({ deal_id: 'DEAL-2026-003', action: 'created', actor_name: 'Arjun Mehta', actor_role: 'sales_rep', daysAgo: 3 }),
  auditEntry({ deal_id: 'DEAL-2026-003', action: 'approved_technical', actor_name: 'Vikram Patel', actor_role: 'technical', daysAgo: 2 }),
  auditEntry({ deal_id: 'DEAL-2026-004', action: 'created', actor_name: 'Arjun Mehta', actor_role: 'sales_rep', daysAgo: 2 }),
...
export const MOCK_QUOTES: Deal[] = [
  {
    ...
    total_cost: 2750000,
    net_margin_pct: 20.29,
    gross_margin_pct: 20.29,
    created_by: 'demo-sales',
  ...
  },
  {
    ...
    total_cost: 2720000,
    net_margin_pct: 21.38,
    gross_margin_pct: 21.38,
    created_by: 'demo-sales',
    sales_rep_id: 'demo-sales',
    sales_rep_name: 'Arjun Mehta',
    sales_head_id: 'demo-head',
  ...
  },
  {
    ...
    total_cost: 4500000,
    net_margin_pct: 22.41,
    gross_margin_pct: 22.41,
    created_by: 'demo-sales-2',
  ...
  },
  {
    ...
    total_cost: 7500000,
    net_margin_pct: 21.05,
    gross_margin_pct: 21.05,
    created_by: 'demo-sales-3',
